...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Pierwszy test")]
        [NUnit.Framework.CategoryAttribute("tag1")]
        public virtual void PierwszyTest()
        {
            string[] tagsOfScenario = new string[] {
                    "tag1"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Pierwszy test", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 4
